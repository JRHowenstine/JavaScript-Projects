...
function show() {
    /* This sets th etask that was retrieved as a variable. */
    var todos = get_todos();
...
/* This will keep th einputs displayed permanently on the screen. */
show();
...
function remove() {
    ...
    todos.splice(id, 1);
    localStorage.setItem('todo', JSON.stringify(todos));
    /* This looks in the show() funcction how to display a removed item on the screen. */
    show();
